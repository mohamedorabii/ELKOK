...
class CheckoutService
{
    ...
    public function calculateTotals($cartItems, ?string $governorate = null)
    {
        $shipping = $governorate
            ? (ShippingSetting::where('governorate', $governorate)->value('price') ?? 0)
            : 0;
    ...
    {
        return ShippingSetting::orderBy('governorate')->get(['governorate', 'price']);
    }
