        ...
        <div class="row mt-4">
            <div class="col-12 text-center">
                <ul style="display:flex; gap:10px; justify-content:center; list-style:none; padding:0;">
                    ...
                    @else
                        <li><a href="{{ $categories->previousPageUrl() }}" class="main_btn">← {{ __('store.common.prev') }}</a></li>
                    @endif
                    ...
                    @if ($categories->hasMorePages())
                        <li><a href="{{ $categories->nextPageUrl() }}" class="main_btn">{{ __('store.common.next') }} →</a></li>
                    @else
